...
return new class extends Migration {
    ...
    public function up(): void {
        ...
        DB::table("sub_sections")->insert([
            ...
            ["id" => 7, "section_id" => 4, "slug" => "sbc_items-subscriptions", "name" => "items-subscriptions", "dom_id" => "menu-item-catalogs-subscriptions", "dom_label" => "Membresías", "dom_route" => "subscriptions.index"],
            ...
            ["id" => 13, "section_id" => 8, "slug" => "sbc_configuration-branches", "name" => "configuration-branches", "dom_id" => "menu-item-configuration-branches", "dom_label" => "Sucursales", "dom_route" => "branches.index"],
            ...
            ["id" => 20, "section_id" => 3, "slug" => "sbc_trackings-customers", "name" => "trackings-customers", "dom_id" => "menu-item-trackings-customers", "dom_label" => "Expediente", "dom_route" => "tracking_customers.index"],
        ]);
