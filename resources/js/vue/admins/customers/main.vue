            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <inputText
                                ...
                                <template v-slot:inputGroupAppend>
                                    <button class="btn btn-primary waves-effect"
                                            ...
                                            @click="consultNumberDocument({functionName: 'createCustomer', numberDocument: forms.customers.add.data.number_document, type: forms.customers.add.data.type_document})">
                                        <i class="fa fa-search"></i>
                                    </button>
                                </template>
                            </inputText>
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <inputSelect
                            v-model="forms.customers.add.data.gender"
                            :options="forms.customers.add.options.gender"
                            :showDiv="true"
                            title="Género"
                            :required="true"
                            :showTextBottom="true"
                            :textBottomInfo="forms.customers.add.errors?.gender"
                            :xl="6"
                            :lg="6"
                            :md="12"
                            :sm="12">
