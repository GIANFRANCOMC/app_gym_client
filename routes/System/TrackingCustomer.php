...
Route::post('qrCamera',              [TrackingCustomerController::class, 'qrCamera'])->name("$entity.qrCamera");
Route::post('qrScanner',             [TrackingCustomerController::class, 'qrScanner'])->name("$entity.qrScanner");
